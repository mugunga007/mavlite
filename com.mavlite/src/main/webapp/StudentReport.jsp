...
<div class="col-md-8">
  ...
  <div class="panel-heading"> <i class="fas fa-user-plus fa-lg " style="color:green"></i>  Student Information</div>
  <div class="panel-body">
 <h2>Confirmation</h2>
  
  <p>Firstname: <b><%=student.getFirstname() %></b> </p>    
   <p>Lastname: <b><%=student.getLastname() %></b> </p>    
    <p>Email: <b><%=student.getEmail() %></b> </p>  
    <p>Supervisor: <b> <%=professorservice.getProfessorById(student.getProfessor_id()).getName() %></b> </p>   
